...
namespace Api.Shared
{
    ...
    public static class TransferEmailTemplate
    {
        public static string Subject = "Transfer Confirmation";

        public static string Message(string senderName, string receiverName, string amount, string accountNumber)
        {
            var message = $@"
                            <html>
                            <head>
                            ...
                            <div class='container'>
                                ...
                                <div class='content'>
                                    <p>Dear {senderName},</p>
                                    <p>Your transfer of <span style={"color:red;"}>{amount}</span> to {receiverName} has been successfully processed.</p>
                                    <p><strong>Account Number:</strong> {accountNumber}</p>
            ...
            var message = $@"
                            ...
                            <div class='container'>
                                ...
                                <div class='content'>
                                    ...
                                    <p><strong>From Account Number:</strong> *****{fromAccountNumber[^1..]}</p>
                                    <p><strong>To Account Number:</strong> *****{toAccountNumber[^1..]}</p>
                                    <p>If you have any questions or need assistance, please contact our support team.</p>
                                    <p style={"color: red;"}> If this was not you, please dispute the transfer via the CLI immediately.</p>
                                </div>
                                <div class='footer'>
            ...
            var message = $@"
                            ...
                            <div class='container'>
                                ...
                                <div class='content'>
                                    ...
                                    <p><strong>To Account Number:</strong> {toAccountNumber}</p>
                                    <p><strong>From Account Number:</strong> {fromAccountNumber}</p>
                                    <p>If you have any questions or need assistance, please contact our support team.</p>
                                </div>
                                <div class='footer'>
                                &copy; {DateTime.Now.Year} Galaxy Bank. All rights reserved.
